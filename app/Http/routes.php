...
Route::group(['prefix' => 'flocks'], function() {
	...
	Route::post('close_flock/{flock_id}',array('as'=>'closed_flock', 'uses'=>'FlocksController@closeFlock'));
	
});

Route::group(['prefix' => 'other_report'], function() {
	Route::get('/{flock_id}',array('as'=>'other_reports','uses'=>'PeriodicalreportController@index'));
	Route::post('save',array('as'=>'save_report','uses'=>'PeriodicalreportController@store'));
	Route::post('delete/{report_id}',array('as'=>'delete_report','uses'=>'PeriodicalreportController@destroy'));
	Route::get('edit/{report_id}',array('as'=>'edit_periodical_report','uses'=>'PeriodicalreportController@edit'));
	Route::any('save_attachment',array('as'=>'edit_periodical_report','uses'=>'PeriodicalreportController@storeAttachment'));
});
...
Route::group(['prefix' => 'reports'], function() {
	...
	//
	Route::get('periodical_reports/{type}',array('as'=>'periodical_reports','uses'=>'ReportsController@periodicalReports'));
	Route::post('get_periodical_report',array('as'=>'get_periodical_report','uses'=>'ReportsController@getPeriodicalReportsData'));
	Route::post('compare_commulative_feed_weekly',array('as'=>'get_commulative_weekly_feed_comp','uses'=>'ReportsController@commulativeWeeklyFeedComp'));

	Route::post('commulative_feed_comparison',array('as'=>'commulativeFeedCompFlock','uses'=>'ReportsController@commulativeFeedCompFlock'));
	Route::post('comparison_feed_per_egg',array('as'=>'comparisonFeedPerEgg','uses'=>'ReportsController@comparisonFeedPerEgg'));
	Route::post('comp_commulative_daily_mortality',array('as'=>'compCommulativeDailyMortality','uses'=>'ReportsController@compCommulativeDailyMortality'));

	Route::post('comp_egg_perhen_housed',array('as'=>'compEggPerHenHoused','uses'=>'ReportsController@compEggPerHenHoused'));

	Route::post('comp_body_weight',array('as'=>'compBodyWeight','uses'=>'ReportsController@compBodyWeight'));
});
/**/
