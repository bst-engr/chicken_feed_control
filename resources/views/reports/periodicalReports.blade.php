    ...
    <div class="col-sm-12 widgets panel_container">
      <div class="row panel_container_top">
        ...
        <div id="flock_wise_reports">
          <div class="table-responsive section_reports hideIt" id="section_periodical_reports">
              <table class="table table-bordered table-stripped" id="periodical_reports_table">
                    <thead>
                      <tr>
                        <td>Entry Date</td>
                        <td>Title</td>
                        <th>Description</th>
                        <td valign="bottom">Attachment</td>
                      </tr>
                    </thead>
...
$(function(){
  ...
  $("#generate_report").click(function(){
    //checks for report format either flock wise or comparitive.
      ...
      generatePeriodicalReport('{{$typeN}}');
