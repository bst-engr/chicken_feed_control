...
@section('title')
 System Reports - Daily Mortalities Report
@stop
        ...
        <div id="flock_wise_reports">
          <div class="table-responsive section_reports hideIt" id="section_feed_mortality">
             <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#daily_mortaltity_record">Daily Mortality Record</a></li>
                <li><a data-toggle="tab" href="#commulative_mortaltity_record">Commulative Mortality Record</a></li>
                
              </ul>
              <div class="tab-content">
                <div id="daily_mortaltity_record" class="tab-pane fade in active">
                ...
                <div id="commulative_mortaltity_record" class="tab-pane fade">
                    <table class="table table-bordered table-stripped" id="daily_feed_mortality_commulative" width="100%">
                    <thead>
                      <tr>
                        <td rowspan="2" valign="bottom">Entry Date</td>
                        <td rowspan="2" valign="bottom">Flock Age(week)</td>
                        <td rowspan="2" valign="bottom">Flock Age(Day)</td>
                        <td colspan="2" align="center"><strong>Cumulative Daily Mortality Record</strong></td>
                        <td colspan="2" align="center"><strong>Cumulative Flock Mortality %</strong></td>
                      </tr>
                      <tr>
                        <td class="standard_feed_per_bird">Standard</td>
                        <td class="feed_per_bird">Actual</td>
...
$(function(){
  ...
  $("#generate_report").click(function(){
    //checks for report format either flock wise or comparitive.
      ...
      generateReportData('feed_mortality');
