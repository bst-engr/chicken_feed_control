...
@section('title')
 System Reports - Eggs Per Hen Housed
@stop
    ...
    <div class="col-sm-12 widgets panel_container">
      <div class="row panel_container_top">
       ...
       <div id="flock_wise_reports">
          <div class="table-responsive section_reports hideIt" id="section_eggs_per_hen_housed">
              <table class="table table-bordered table-stripped" id="eggs_per_hen_housed_table">
                    <thead>
                      <tr>
                        <td rowspan="2" valign="bottom">Entry Date</td>
                        <td rowspan="2" valign="bottom">Flock Age(week)</td>
                        <td colspan="2" align="center"><strong>Number of Eggs</strong></td>
...
$(function(){
  ...
  $("#generate_report").click(function(){
    //checks for report format either flock wise or comparitive.
      ...
      WeeklyReportings('eggs_per_hen_housed');
