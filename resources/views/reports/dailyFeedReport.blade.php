...
@section('title')
 System Reports - Daily Feed Report
@stop

@section('page_title')
  Generate Daily Feed Report
@stop
        ...
        <div id="flock_wise_reports">
            ...
            <div class="table-responsive section_reports hideIt" id="section_feed_per_bird">
              <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#feed_per_bird_rep">Daily Feed Consumption/Egg</a></li>
...
$(function(){
  ...
  $("#generate_report").click(function(){
    //checks for report format either flock wise or comparitive.
      ...
      generateReportData('feed_per_bird');
